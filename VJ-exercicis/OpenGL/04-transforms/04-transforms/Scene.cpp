...
void Scene::render()
{
	...
	// increase/decrease size + spin + move left/right
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(sin(currentTime / 1000.f) * 100.0f, 0.f, 0.f));	// esquerra - dreta
